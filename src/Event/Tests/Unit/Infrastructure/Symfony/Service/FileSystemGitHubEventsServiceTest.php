...
use App\Event\Infrastructure\Symfony\Service\FileSystemGitHubEventsService;
...
class FileSystemGitHubEventsServiceTest extends TestCase
{
    ...
    public function testGetEventsReturnsValidEvents(): void
    {
        ...
        $mockEvent1 = $this->createMock(\App\Event\Domain\Entity\Event::class);
        $mockEvent2 = $this->createMock(\App\Event\Domain\Entity\Event::class);
